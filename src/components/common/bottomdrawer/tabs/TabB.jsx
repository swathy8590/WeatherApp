    ...
    <div>
      ...
      >
        <TabContext value={value}>
          <Box
            sx={{ borderBottom: 1, borderColor: "divider", color: "#E1E1E1" }}
          >
            <TabList
            ...
            >
              <Tab
                ...
                sx={{
                  color:
                    state.theme.colorMode === "dark" ? "#ffffff" : "#343746",
                }}
              />
              <Tab
                scrollButtons={"on"}
                ...
                <TabContext value={innerValue}>
                  ...
                  >
                    ...
                    >
                      {Object.keys(
                        state &&
                          state.api.weatherData !== "" &&
                          state?.api.weatherData?.daily[0]?.values
                      ).map((value, index) => (
                        <Tab
                          key={index}
                          variant="scrollable"
                        ...
                        <Box sx={{ paddingBottom: "100px" }}>
                          <ThemeProvider theme={theme}>
                            ...
                            >
                              ...
                              >
                                <ListAltIcon
                                  sx={{ color: state.theme.backgroundColor }}
                                />
                              </ToggleButton>
                                ...
                                <TableBody>
                                  {
                                    <>
                                      {state &&
                                        state.api.weatherData !== "" &&
                                        state?.api.weatherData?.daily.map(
                                          (val, indx) => (
                                            <TableRow
                                              sx={{
                                                background:
                ...
                <TabContext value={innerValue}>
                  ...
                  >
                    ...
                    >
                      {Object.keys(
                        state &&
                          state.api.weatherData !== "" &&
                          state?.api.weatherData?.hourly[100]?.values
                      ).map((hValue, hIndx) => (
                        <Tab
                          label={hValue}
                          key={hIndx}
                  ...
                  >
                    {Object.keys(
                      ...
                      <TabPanel value={hIndx} key={hIndx}>
                        <Box>
                          <ThemeProvider theme={theme}>
                            <ToggleButtonGroup
                              orientation="vertical"
                                ...
                                <TableBody>
                                  {" "}
                                  {
                                    <>
                                      {state &&
                                        state.api.weatherData !== "" &&
                                        state.api.weatherData.hourly.map(
                                          (hVal, hInx) => (
                                            <TableRow
                                              sx={{
                                                background:
                  ...
                  >
                    ...
                    >
                      {Object.keys(
                        state &&
                          state.api.weatherData !== "" &&
                          state?.api.weatherData?.minutely[0].values
                                ...
                                <TableBody>
                                  {
                                    <>
                                      {state &&
                                        state.api.weatherData !== "" &&
                                        state?.api.weatherData?.minutely.map(
                                          (minVal, minIndx) => (
                                            <TableRow
                                              sx={{
                                                background:
